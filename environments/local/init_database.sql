...
(3, '{"logic": "AND", "conditions": [{"condition": {"logic": "None", "fields": [{"table": "dws_user.dws_user_trading_df", "field": "contract_recent_30d_trading_volume", "operator": ">", "value": "10000", "type": "number"}]}}]}'),
