-- DWS层用户指标宽表定义
-- 根据 Metric_mapping.txt 中的指标分类创建相应的DWS层表结构
-- 更细化的业务领域表设计，便于维护和查询优化
...
LOCATION
    's3://exchanges-flink-prod/batch/data/dws/dws_user/dws_user_profile_df/';
--s3://exchanges-flink-prod/batch/data/dws/dws_user/
...
CREATE EXTERNAL TABLE IF NOT EXISTS dws_user.dws_user_asset_df (
  ...
  -- 充值提现相关
  total_deposit_amount STRING COMMENT '累计充值金额', --已有
  total_withdraw_amount STRING COMMENT '累计提现金额', --已有
  net_deposit_amount STRING COMMENT '累计净入金金额',--已有
...
OUTPUTFORMAT
    'org.apache.hadoop.hive.ql.io.parquet.MapredParquetOutputFormat'
LOCATION
    's3://exchanges-flink-prod/batch/data/dws/dws_user/dws_user_asset_df/';
...
OUTPUTFORMAT
    'org.apache.hadoop.hive.ql.io.parquet.MapredParquetOutputFormat'
LOCATION
    's3://exchanges-flink-prod/batch/data/dws/dws_user/dws_user_trading_df/';
...
OUTPUTFORMAT
    'org.apache.hadoop.hive.ql.io.parquet.MapredParquetOutputFormat'
LOCATION
    's3://exchanges-flink-prod/batch/data/dws/dws_user/dws_user_activity_df/';
...
OUTPUTFORMAT
    'org.apache.hadoop.hive.ql.io.parquet.MapredParquetOutputFormat'
LOCATION
    's3://exchanges-flink-prod/batch/data/dws/dws_user/dws_user_risk_df/';
...
OUTPUTFORMAT
    'org.apache.hadoop.hive.ql.io.parquet.MapredParquetOutputFormat'
LOCATION
    's3://exchanges-flink-prod/batch/data/dws/dws_user/dws_user_marketing_df/';
...
OUTPUTFORMAT
    'org.apache.hadoop.hive.ql.io.parquet.MapredParquetOutputFormat'
LOCATION
    's3://exchanges-flink-prod/batch/data/dws/dws_user/dws_user_behavior_df/';